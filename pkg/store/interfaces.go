...
type StoreInterface interface {
	...
	GetDentistIdByLicense (license string) (int, error)
	...
	CreateAppointmentByDNIAndLicense (DNI string, license string, appointment domain.Appointment) (*domain.Appointment, error)
